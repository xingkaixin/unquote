...
export interface Messages {
  ...
  readonly "agent.detail": string;
  readonly "agent.detailEvent": string;
  readonly "agent.closeDetail": string;
  readonly "agent.noConversation": string;
  readonly "agent.line": string;
  readonly "agent.lineLabel": string;
  readonly "agent.turn": string;
  readonly "agent.turnLabel": string;
  readonly "agent.kind": string;
  readonly "agent.timestamp": string;
  readonly "agent.recordId": string;
  readonly "agent.requestId": string;
  readonly "agent.stopReason": string;
  readonly "agent.usage": string;
  readonly "agent.content": string;
  readonly "agent.copyContent": string;
  readonly "agent.openJson": string;
