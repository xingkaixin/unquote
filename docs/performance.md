...
| Total UI JavaScript | 800,000 bytes |
| Total UI JavaScript gzip | 260,000 bytes |
...
The combined comparison and table workspace uses a total UI budget of 800,000 bytes / 260,000 bytes gzip. Feature-specific measurements above were taken before integration.
