...
export default defineConfig({
  test: {
    projects: [
      ...
      "packages/ui/vitest.agent.config.ts",
      "apps/web/vitest.config.ts",
      "apps/extension/vitest.config.ts",
      "apps/safari/vitest.config.ts",
    ...
    coverage: {
      ...
      thresholds: {
        ...
        "packages/ui/src/components/node-inspector.tsx": hotspotThresholds,
        "packages/ui/src/hooks/use-parser.ts": hotspotThresholds,
        "packages/ui/src/lib/agent-session/model.ts": hotspotThresholds,
